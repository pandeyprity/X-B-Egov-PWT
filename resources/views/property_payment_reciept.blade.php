    ...
    <body>   
        <div style="width: 1000px; margin:0 auto;">           
            ...
            <table id="table"  class="sml">
                @if(!$data['receiptDtls']['isArrearReceipt']??false)
                    <thead>
                        <tr id="tableRow">
                            ...
                            <th style="border: 1px solid gray; border-collapse: collapse; font-weight: 600;"><b>(B)</b> Current Demand (2023 -
                                24) </th> 
                            <th style="border: 1px solid gray; border-collapse: collapse; font-weight: 600;"><b>(C)</b> Current Recovery (if
                                any) </th> 
                            <th style="border: 1px solid gray; border-collapse: collapse; font-weight: 600;"> <b>(A+B+C)</b> Grand Total
                                (2023-24) </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @if(!$data['receiptDtls']['isArrearReceipt']??false)
                                ...
                                <tr>
                                    <td class="th"> 3 </td>
                                    <td class="th"> &nbsp; Fire Fighting Taxsdfsaf sdfasfdsd fsd </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
                                ...
                                <tr>
                                    <td class="th"> 12 </td>
                                    <td class="th"> &nbsp; Sp Education Tax </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
                                    <td class="th"> 0 </td>
