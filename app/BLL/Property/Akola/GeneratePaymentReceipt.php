...
class GeneratePaymentReceipt
{
    ...
    public function addPropDtls()
    {
        $receiptDtls = [
            ...
            "customerName" => ($this->_propertyDtls->applicant_name) ? $this->_propertyDtls->applicant_name : $this->_propertyDtls->applicant_marathi,
            "ownerName" => ($this->_propertyDtls->owner_name) ? $this->_propertyDtls->owner_name : $this->_propertyDtls->owner_name_marathi,
            "guardianName" => ($this->_propertyDtls->guardian_name) ? $this->_propertyDtls->guardian_name : $this->_propertyDtls->guardian_name_marathi,
