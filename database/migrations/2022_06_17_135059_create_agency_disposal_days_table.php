...
class CreateAgencyDisposalDaysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agency_disposal_days', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('agency_disposal_days');
    }
}
