...
class CreateActiveSafDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('active_saf_details', function (Blueprint $table) {
            ...
            $table->string('prop_dist', 100)->nullable();
            $table->string('prop_pin_code', 6)->nullable();
            $table->boolean('is_corr_add_differ')->nullable();
            $table->string('corr_address')->nullable();
            $table->string('corr_city')->nullable();
            $table->string('corr_dist', 100)->nullable();
            $table->string('corr_pin_code', 6)->nullable();
            ...
            $table->bigInteger('escalate_by')->nullable(true);
    ...
    {
        Schema::dropIfExists('active_saf_details');
    }
}
