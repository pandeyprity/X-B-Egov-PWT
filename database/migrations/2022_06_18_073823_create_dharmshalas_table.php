...
class CreateDharmshalasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dharmshalas', function (Blueprint $table) {
            $table->id();

            $table->string('RenewalID', 15)->nullable();
            $table->string('UniqueID', 15)->nullable();
            $table->string('OldRenewalID', 10)->nullable();
            ...
            $table->mediumText('ModifiedOn')->nullable();
    ...
    {
        Schema::dropIfExists('dharmshalas');
    }
}
