...
class CreatePlAdvertisementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pl_advertisements', function (Blueprint $table) {
            $table->id();
            ...
            $table->mediumText('InstallationPlace')->nullable();
            $table->mediumText('BrandDisplayName')->nullable();
            $table->mediumText('BrandDisplayAddress')->nullable();
            $table->mediumText('BrandDisplayHolding')->nullable();
            $table->integer('DisplayArea')->nullable();
            $table->integer('NoOfHoardings')->nullable();
            ...
            $table->mediumText('BrandDisplayPermissionPath')->nullable();
    ...
    {
        Schema::dropIfExists('pl_advertisements');
    }
}
